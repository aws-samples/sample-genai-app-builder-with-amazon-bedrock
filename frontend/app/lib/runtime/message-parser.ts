...
const ARTIFACT_TAG_OPEN = '<vibeArtifact';
const ARTIFACT_TAG_CLOSE = '</vibeArtifact>';
const ARTIFACT_ACTION_TAG_OPEN = '<vibeAction';
const ARTIFACT_ACTION_TAG_CLOSE = '</vibeAction>';
